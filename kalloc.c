/*
 * physocal memory allocator, intended to be used to allocate
 * memory for user process. allocates in 4096-bytes "pages".
 * free list is sorted and combines adjacent pages into
 * long runs, to make it easier to allocate bit segment.
...
/*
 * initialize free list of physocal pages. this code
 * cheats by just considering the one megabytes of pages
 * after _end.
 */
void
kinit(void)
 ...
 * returns 0 if there's no run that's big enoygh.
 */
char *
kalloc(int n)
{
